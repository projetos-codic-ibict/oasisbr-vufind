 ...
 *
 *  Edits to original code - lmgonzales 2018-10-26
 *   changed L:19 from L.Layer.extend to L.LayerGroup.extend
 *   removed L:20 includes: L.Mixin.Events,
 *
 *  Notes about versioning:
 *    Source code is version 1.1, commit ad96a41 (25 Jul 2018)
 *    https://github.com/cloudybay/leaflet.latlng-graticule/commit/ad96a419c6da71e4effa911856ada59a9f0c2ca6
 *
 */

(function (window, document, undefined) {
    // Change - lmgonzales - 2018-10-26
    // Commenting out the original code because browser throws deprecated function warnings.
    // L.LatLngGraticule = L.Layer.extend({
    //    includes: L.Mixin.Events,
    // Fix is to apply the following line of code:
     L.LatLngGraticule = L.LayerGroup.extend({
        ...
        __draw: function (label) {
            ...
            if (L.Browser.canvas && map) {
                ...
                let txtHeight = 12;
                try {
                    const _font_size = ctx.font.split(' ')[0];
                ...
                let ll; let latstr; let lngstr; let _lon_delta = 0.5;
                function __draw_lat_line (self, lat_tick) {
                    ...
                    if (curvedLat) {
                        ...
                        var __lon_left = _lon_l; var __lon_right = _lon_r;
                        if (ll.x > 0) {
